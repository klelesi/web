...
function RegisterForm({
    ...
    return <div className="py-6">
        ...
        <form action="" onSubmit={(event) => submit(event)}>
            ...
            <FormInput label={'Email:'} type={'email'} name={'email'} value={form.email}
            ...
            <div className={'mt-6 prose'}>
                <label className={'flex flex-row items-center'}><input
                    disabled={currentState === ViewState.SAVING}
        ...
        <div className="text-center">
            ...
            <a href="/prijava">
                <button className="btn btn-sm btn-primary-outline"
                        disabled={currentState === ViewState.SAVING}>Prijavi se
                </button>
            </a>
        </div>
    </div>;
...
function SuccessState() {
    return <div className={'py-6 text-center'}>
        ...
        <p className={'mb-3'}>Zelo nas veseli, da smo te prepričali, da postaneš del naše
            skupnosti.</p>
