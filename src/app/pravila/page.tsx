...
export default function Page() {
  return (
    <main>
      <div className="container w-page">
        <Card>
          ...
          <div className="mb-6">
            ...
            <p>Prepovedana je razžalitev, obrekovanje, žaljiva obdolžitev, opravljanje, in kakršnokoli spodbujanje neenakopravnosti.</p>
          </div>
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-bold mb-1">#2 Primerna vsebina</h2>
            <p>
              Prispevki se morajo vsebinsko povezovati s skupino v kateri so objavljeni. <br /> Komentarji se morajo nanašati na temo objave.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p>
              Vsebina, ki ne bo v skladu s temi pravili bo ustrezno popravljena ali izbrisana. <br />
              Vnovični kršitelji bodo odstranjeni in blokirani.
            </p>
          </div>

          <p className="text-sm text-dark-gray text-right mt-12">Posodobljeno 8.4.2025</p>
        </Card>
      </div>
    </main>
  );
