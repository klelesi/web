                    ...
                    <div className="card mb-4">
                        ...
                        <div className="flex flex-row">
                            <div className="flex flex-col">
                                <div className="mt-1">
                                    <PostMeta author={{name: 'Miha Medven', username: 'aweCodeMan'}} createdAt={'2022-11-12 10:00'}/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-4 prose">
                            ...
                            <p>Med s.p.jevci podobno kot lansko leto ni večjih razlik, še vedno je <b>87%</b> takih, ki
                                bi jih lahko šteli pod ekonomsko odvisne osebe (en
                            ...
                            <p><b>1212 (94,9%)</b> razvijalcev je redno zaposlenih in ima pogodbo za nedoločen čas, prav
                                tako jih <b>1260
                            ...
                            <p>Še enkrat, zgornje opozorilo je treba vedno imeti v mislih, ko
                                se pogovarjate o izsledkih te ankete. <b>Resno</b>. Ker potem ljudje meni težijo, da
                                moja
