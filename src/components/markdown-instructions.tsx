...
export default function MarkdownInstructions() {
  ...
  return (
    <>
      <button type={"button"} className="btn btn-sm btn-primary-outline" onClick={() => setIsOpened(!isOpened)}>
        {isOpened ? "Skrij navodila" : "Prikaži navodila"}
      </button>
    ...
    <div className="flex flex-col bg-light-gray">
      ...
      <div className="flex flex-row">
        ...
        <div className="text-center  text-sm border-b border-r border-l p-1 flex-1">
          <div className="prose">
            <p>
              <a href="https://klele.si">klele.si!</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-row ">
        <div className="text-center  text-sm border-b border-r border-l p-1 flex-1 flex justify-center items-center">
          <p>
            * stvar 1 <br />* stvar 2 <br />* stvar 3 <br />
          </p>
        </div>
